...
A quick start Angular project that shows how to group nodes and connectors in an [Angular Diagram](https://www.syncfusion.com/diagram-sdk/angular-diagram) component. This project includes code snippets to create and update groups dynamically. It also includes code snippets to add annotations to a group and create a nested group.
